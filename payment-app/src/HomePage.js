// HomePage.js - This is your current App.js content with routing integration
...
function HomePage() {
  ...
  const getSessionId = async () => {
    ...
    try {
      ...
      const response = await fetch('https://hosted-checkout-backend-payment-pag.vercel.app/', {
        method: 'POST',
        headers: {
